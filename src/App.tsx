...
function Spinner() {
  return (
    <div className="loading-shell" style={{width:'100%',minWidth:0,minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',background:'var(--bg)',flexDirection:'column',gap:16,textAlign:'center'}}>
